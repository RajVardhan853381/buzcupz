...
export class CostManagementController {
    ...
    async deleteCostEntry(
        ...
        await this.costService.deleteCostEntry(restaurantId, id, deleteRecurring === 'true');
    }
    ...
    async getEmployees(
        ...
        return this.costService.findAllEmployees(restaurantId, includeInactive === 'true');
    }
