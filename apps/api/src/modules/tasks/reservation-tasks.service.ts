...
export class ReservationTasksService {
    ...
    async send24HourReminders() {
        ...
        try {
            ...
            this.logger.log(`Found ${reservations.length} reservations needing 24h reminder`);
            ...
            for (const reservation of reservations) {
                try {
                    ...
                    this.logger.log(`24h reminder sent for reservation ${reservation.id}`);
                } catch (error) {
                    this.logger.error(
    ...
    async send1HourReminders() {
        ...
        try {
            ...
            this.logger.log(`Found ${reservations.length} reservations needing 1h reminder`);
    ...
    async autoCompleteReservations() {
        ...
        try {
            ...
            this.logger.log(`Found ${seatedReservations.length} reservations to auto-complete`);
