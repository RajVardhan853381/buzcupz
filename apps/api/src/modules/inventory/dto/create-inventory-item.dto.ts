...
export class CreateInventoryItemDto {
  ...
  @ApiPropertyOptional({
    example: "Premium Italian extra virgin olive oil, cold pressed",
  })
  @IsOptional()
  @IsString()
  @Length(0, 500)
  ...
  @ApiPropertyOptional({
    example: 50,
    description: "Quantity to order when reordering",
  })
  @IsOptional()
  @Type(() => Number)
  @IsNumber({ maxDecimalPlaces: 4 })
  ...
  @ApiPropertyOptional({
    example: 365,
    description: "Shelf life in days for perishables",
  })
  @IsOptional()
  @Type(() => Number)
  @IsNumber()
