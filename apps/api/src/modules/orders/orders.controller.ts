...
export class OrdersController {
    ...
    async updateItemStatus(
        ...
        return this.ordersService.updateItemStatus(orderId, itemId, status, restaurantId, userId);
    }
    ...
    async cancel(
        ...
        return this.ordersService.cancel(id, reason || 'No reason provided', restaurantId);
    }
}
