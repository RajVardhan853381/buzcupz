...
describe('OrdersService', () => {
    ...
    describe('create', () => {
        ...
        it('should create a dine-in order successfully', async () => {
            ...
            expect(mockBroadcastNewOrder).toHaveBeenCalledWith(restaurantId, mockOrder);
        });
        ...
        it('should calculate totals correctly with tax', async () => {
            // Arrange
            mockTableFindFirst.mockResolvedValue(mockTable);
            mockRestaurantFindUnique.mockResolvedValue({ ...mockRestaurant, taxRate: 10 });
            mockMenuItemFindMany.mockResolvedValue([mockMenuItem]);
        ...
        it('should create order for takeout without table', async () => {
            ...
            mockMenuItemFindMany.mockResolvedValue([mockMenuItem]);
            mockOrderFindFirst.mockResolvedValue(null);
            mockOrderCreate.mockResolvedValue({ ...mockOrder, type: 'TAKEAWAY', tableId: null });
            mockQueueAdd.mockResolvedValue({});
    ...
    describe('findAll', () => {
        ...
        it('should filter by multiple statuses', async () => {
            ...
            // Act
            await service.findAll(restaurantId, { statuses: [OrderStatus.PENDING, OrderStatus.CONFIRMED] });
        ...
        it('should handle pagination correctly', async () => {
            ...
            // Act
            const result = await service.findAll(restaurantId, { page: 2, limit: 10 });
    ...
    describe('updateStatus', () => {
        ...
        it('should update table to CLEANING when order is COMPLETED', async () => {
            ...
            mockOrderUpdate.mockResolvedValue({ ...servedOrder, status: 'COMPLETED' });
    ...
    describe('cancel', () => {
        it('should cancel a pending order', async () => {
            ...
            // Act
            const result = await service.cancel('order-1', 'Customer request', restaurantId);
